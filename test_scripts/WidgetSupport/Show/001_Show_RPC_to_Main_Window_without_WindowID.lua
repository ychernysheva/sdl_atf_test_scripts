...
--
-- Description: Check app is able to successfully send Show RPC to Main window
...
-- Steps:
-- 1) App send Show(without WindowID) request to SDL
-- SDL does:
...
common.Title("Test")
common.Step("Success Show RPC to Main window without windowID", common.sendShowToWindow, { nil })
