...
--
-- Description: Check app will receive "GENERIC_ERROR" to the "CreateWindow" request if HMI response is invalid
--
-- Precondition:
...
common.Title("Test")
common.Step("App sends CreateWindow RPC", createWindowUnsuccess)
