...
--
-- Description: Check different apps be able to successfully create widgets with the same Id
--
-- Precondition:
...
-- Steps:
-- 1) App2 creates a widget with the same id and name as the App1
-- SDL does:
...
common.Step("App1 create a widget", common.createWindow, { params, 1 })

common.Title("Test")
common.Step("App2 create a widget with the same id as the App1", common.createWindow, { params, 2 })
