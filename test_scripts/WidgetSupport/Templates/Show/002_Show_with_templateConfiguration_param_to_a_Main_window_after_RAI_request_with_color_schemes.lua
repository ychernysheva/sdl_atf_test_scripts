...
--
-- Description: Check that SDL proceed with "Show" RPC in case if color schemes have been defined
...
-- 3) App is activated
-- Steps:
-- 1) App sends Show request with different value for the templateConfiguration param to Main window
-- SDL does:
