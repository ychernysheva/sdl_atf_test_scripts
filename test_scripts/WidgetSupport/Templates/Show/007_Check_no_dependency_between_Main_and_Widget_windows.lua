...
-- in case of setting `templateConfiguration` (Main-Widget)
--
-- Precondition:
...
--    in `templateConfiguration` param to Widget window
-- SDL does:
--  - proceed with request successfully (such request for Main window will be rejected)
---------------------------------------------------------------------------------------------------
