...
--
-- Description: Check that SDL proceed with "Show" RPC to widget in case if no color schemes have been defined
-- during app registration
--
-- Preconditions:
-- 1) SDL and HMI are started
-- 2) App registered and activated (no color schemes are defined)
...
-- 2) App sends 2nd "Show" request to Widget with different parameters
-- SDL does:
...
for n, tc in common.spairs(testCases) do
  ...
  common.Title("Test")
  common.Step("Set initial state for Widget", setInitialState, { paramsWidget.windowID })
