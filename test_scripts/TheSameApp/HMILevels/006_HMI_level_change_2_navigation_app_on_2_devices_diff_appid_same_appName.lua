...
--   Check:
--    SDL sends OnHMIStatus( hmiLevel = "BACKGROUND", audioStreamingState = "NOT_AUDIBLE") to Mobile №2
--    SDL sends OnHMIStatus( hmiLevel = FULL ) to Mobile №1
-- 3)Deactivate Application 1
--   Check:
--    SDL does NOT send OnHMIStatus to Mobile №2
--    SDL sends OnHMIStatus( hmiLevel = "LIMITED", audioStreamingState = "AUDIBLE") to Mobile №1
-- 4)Activate Application 2 once again
--   Check:
--    SDL sends OnHMIStatus( hmiLevel = FULL ) to Mobile №2
--    SDL NOT sends OnHMIStatus() to Mobile №1
...
-- 7)Activate Application 1 once again
--   Check:
--    SDL does NOT send OnHMIStatus to Mobile №2
--    SDL sends OnHMIStatus( hmiLevel = FULL ) to Mobile №1
---------------------------------------------------------------------------------------------------
