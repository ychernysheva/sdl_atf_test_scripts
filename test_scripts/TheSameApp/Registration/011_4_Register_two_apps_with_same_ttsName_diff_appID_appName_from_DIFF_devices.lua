...
--    SDL sends OnAppRegistered(application.appName = "Test Application", ttsName = "TtsName") notification to HMI
...
--    SDL sends OnAppRegistered(application.appName = "Test Application 2", ttsName = "TtsName") notification to HMI
---------------------------------------------------------------------------------------------------
