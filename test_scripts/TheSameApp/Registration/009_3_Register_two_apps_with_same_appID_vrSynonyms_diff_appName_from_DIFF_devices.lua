...
-- Description:
-- Two mobile applications with the same appIDs and vrSynonyms and different appNames, are registering from different
...
--    appName = "Test Application 2" and vrSynonyms = "vrApp" to SDL
--   Check:
