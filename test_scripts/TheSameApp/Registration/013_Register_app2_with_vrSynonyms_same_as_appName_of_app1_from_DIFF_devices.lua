...
-- Description:
-- Check of successful registration of application with vrSynonym value which matches
--  appName of already registered application if it registers from another mobile device
--
-- Precondition:
...
--    SDL sends OnAppRegistered(application.appName = "Test Application 2", vrSynonyms = "Test Application") notification to HMI
---------------------------------------------------------------------------------------------------
