...
--   Check:
--    SDL sends Buttons.SubscribeButton("OK", appId_2) to HMI
--    SDL receives Buttons.SubscribeButton ("SUCCESS") response from HMI
...
runner.Step("App 1 from Mobile 1 requests Subscribe on Ok",  common.subscribeOnButton, {1, "OK", "SUCCESS" })
...
runner.Step("Activate App 2", common.app.activate, { 2 })
runner.Step("App 2 from Mobile 2 requests Subscribe on Ok",  common.subscribeOnButton, {2, "OK", "SUCCESS" })
