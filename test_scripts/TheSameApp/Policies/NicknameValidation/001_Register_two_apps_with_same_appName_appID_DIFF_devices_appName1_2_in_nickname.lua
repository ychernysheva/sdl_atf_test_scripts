...
-- Description:
-- Registration of two mobile applications with the same appIDs and appNames which are match to the
...
-- 2) Mobile №2 sends RegisterAppInterface request (appID = 0000001, appName = "Test Application") to SDL
--   Check:
