...
-- Description:
-- Registration of two mobile apps from different devices having different appIDs and same appNames.
...
-- 2) Mobile №2 sends RegisterAppInterface request (appID = 00000022, appName = "Test Application") to SDL
--   Check:
