...
-- 7. App_1 stops streaming within 'StopStreamingTimeout' timeout
-- SDL does:
--   - not send Navi.StopStream(App_1) request to HMI
--   - not send EndService(VIDEO) request to App_1
...
local function activateApp2()
  ...
  common.hmi.getConnection():ExpectRequest("Navigation.StopStream")
  :Do(function()
...
runner.Step("Check App1 messages sequence", common.checkSequence,
 { "app1", { "ActivateApp", "OnHMIStatus_Not_Streamable" } })
...
runner.Step("Check HMI messages sequence", common.checkSequence,
 { "hmi", { "ActivateApp", "Navi.OnVideoDataStreaming" } })
