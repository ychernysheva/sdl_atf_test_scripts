...
local grp = {
  ...
  [2] = { name = "Dummy-2", prompt = "Dummy_2", params = common.EMPTY_ARRAY }
}
...
runner.Step("Send GetVehicleData speed", common.getVD, { "speed", "USER_DISALLOWED", false })
runner.Step("Send GetVehicleData rpm", common.getVD, { "rpm", "USER_DISALLOWED", false })
