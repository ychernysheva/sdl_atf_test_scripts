...
--
-- Description:
-- Behavior of SDL during start SDL with Preloaded PT file with one required parameter that has invalid type
...
function Test.Precondition()
  ...
  testCasesForPolicySDLErrorsStops.updatePreloadedPT("data.policy_table.app_policies.device", {priority = 82})
end
