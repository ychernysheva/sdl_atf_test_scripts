...
-- Checking incorrect "preconsented_groups" value - empty array.
...
local function Set_empty_array_as_preconsented_groups()
...
function Test.Precondition_Set_preconsented_groups()
  Set_empty_array_as_preconsented_groups()
end
--[[ Test ]]
...
function Test:TestStep_Validate_emptyArray_preconsented_groups_Preloaded()
