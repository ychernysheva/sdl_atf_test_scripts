...
--1.1 All parameters are present and within bounds speech capabilities is sent with type = "SILENCE "
...
--2.1 SDL sends UI.PerformAudioPassThru (audioPassThruIcon, other params, ttsChunksType = "SILENCE") to HMI
...
function Test:TestStep_PerformAudioPassThru_SILENCE()
  testCasesForPerformAudioPassThru:PerformAudioPassThru_Diff_Speech_Capabilities (self, "SILENCE")
end
