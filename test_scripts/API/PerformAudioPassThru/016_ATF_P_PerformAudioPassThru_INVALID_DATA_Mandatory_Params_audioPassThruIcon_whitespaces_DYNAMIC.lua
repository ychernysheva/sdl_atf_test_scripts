...
-- and is with type DYNAMIC, only mandatory params used in PerformAudioPassThru_request 
-- are present and within bounds (samplingRate, maxDuration, bitsPerSample, audioType)
--
-- 2. Performed steps
-- Send PerformAudioPassThru (audioPassThruIcon contains only whitespaces, mandatory params) from mobile to SDL and check:
--
-- Expected result:
...
function Test:TestStep_Mandatory_Params_audioPassThruIcon_Whitespaces_DYNAMIC()
