...
--1.1. Request is sent with audioPassThruIcon that contains only whitespaces and is with type STATIC and with all mandatory parameters within bounds (samplingRate, maxDuration, bitsPerSample, audioType)
--2. Performed steps
...
function Test:TestStep_Mandatory_Params_audioPassThruIcon_Whitespaces_STATIC()
