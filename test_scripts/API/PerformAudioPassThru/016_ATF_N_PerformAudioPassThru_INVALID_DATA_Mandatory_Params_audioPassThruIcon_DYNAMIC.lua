...
-- and ImageType = DYNAMIC, mandatory params used in PerformAudioPassThru_request 
-- are present and within bounds (samplingRate, maxDuration, bitsPerSample, audioType)
--
-- 2. Performed steps
-- Send PerformAudioPassThru (audioPassThruIcon (invalid value parameter,ImageType = DYNAMIC), mandatory params) from mobile to SDL and check:
--
-- Expected result:
...
for ind = 1, #params_invalid_data do
  Test["TestStep"..ind.."_"..params_invalid_data[ind].comment.."_mandatory_params_DYNAMIC"] = function(self)
