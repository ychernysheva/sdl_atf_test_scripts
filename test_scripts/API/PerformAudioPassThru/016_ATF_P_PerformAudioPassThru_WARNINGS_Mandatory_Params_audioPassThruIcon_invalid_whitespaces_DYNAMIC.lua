...
--1.1. Request is sent with audioPassThruIcon that contains only whitespaces and is with type DYNAMIC and with all mandatory parameters within bounds (samplingRate, maxDuration, bitsPerSample, audioType)
--2. Performed steps
