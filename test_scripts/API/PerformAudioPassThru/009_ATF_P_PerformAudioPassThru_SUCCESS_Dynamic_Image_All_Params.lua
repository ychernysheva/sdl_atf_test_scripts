...
--1. All params used in PerformAudioPassThru_request are present and within bounds, audioPassThruIcon is sent with imageType = "DYNAMIC"
...
function Test:TestStep_PerformAudioPassThru_AllParameters_DYNAMIC_ImageType_SUCCESS()
  testCasesForPerformAudioPassThru:PerformAudioPassThru_DYNAMIC_image_SUCCESS_all (self)
end
