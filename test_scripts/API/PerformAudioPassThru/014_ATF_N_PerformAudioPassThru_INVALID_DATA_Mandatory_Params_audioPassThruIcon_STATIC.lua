...
-- and ImageType = STATIC, mandatory params used in PerformAudioPassThru_request 
-- are present and within bounds (samplingRate, maxDuration, bitsPerSample, audioType)
--
-- 2. Performed steps
-- Send PerformAudioPassThru (audioPassThruIcon (invalid value parameter,ImageType = STATIC), mandatory params) from mobile to SDL and check:
--
-- Expected result:
