...
--1.2. Request is sent with valid audioPassThruIcon parameter with type DYNAMIC and with all mandatory parameters within bounds (samplingRate, maxDuration, bitsPerSample, audioType)
--2. Performed steps
...
function Test:TestStep_Mandatory_Params_Missing_audioPassThruIcon_DYNAMIC()
