...
--1.1. Request is sent with audioPassThruIcon that contains only whitespaces and is with type DYNAMIC, all other params used in PerformAudioPassThru_request are present and within bounds 
--2. Performed steps
...
function Test:TestStep_All_Params_audioPassThruIcon_Whitespaces_DYNAMIC()
