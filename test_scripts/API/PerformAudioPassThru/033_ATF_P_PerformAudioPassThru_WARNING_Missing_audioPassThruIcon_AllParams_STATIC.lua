...
--1.1. Request is sent with valid audioPassThruIcon parameter with type STATIC, all other params used in PerformAudioPassThru_request are present and within bounds 
--2. Performed steps
