...
--1.1 All parameters are present and within bounds speech capabilities is sent with type = "SAPI_PHONEMES"
...
--2.1 SDL sends UI.PerformAudioPassThru (audioPassThruIcon, other params, ttsChunksType = "SAPI_PHONEMES") to HMI
