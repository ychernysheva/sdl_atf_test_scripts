...
--
-- 2. Performed steps
-- Send PerformAudioPassThru (audioPassThruIcon (valid value parameter,ImageType is not valid), other params) from mobile to SDL and check:
--
-- Expected result:
...
for ind = 1, #params_invalid_data do
  Test["TestStep"..ind.."_"..params_invalid_data[ind].comment.."_all_params"] = function(self)
