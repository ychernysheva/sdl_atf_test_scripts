...
--
-- Description:
-- App requests SendLocation in case parameters section is omitted in PT
--
-- Steps:
...
local function ptuUpdateFuncDissalowedRPC(tbl)
	...
	if SendLocstionRpcs["SendLocation"].parameters then SendLocstionRpcs["SendLocation"].parameters = nil end
end
...
runner.Title("Test")
runner.Step("SendLocation_parameters_omitted_in_policy_table", sendLocation, { requestParams })
