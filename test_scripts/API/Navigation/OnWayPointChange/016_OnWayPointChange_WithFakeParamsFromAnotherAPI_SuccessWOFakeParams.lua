...
local function onWayPointChange(self)
  ...
  :ValidIf (function(_, data)
			 if data.payload.sliderPosition or
			    data.payload.wayPoints[1].sliderPosition or
				data.payload.wayPoints[1].coordinate.sliderPosition or
				data.payload.wayPoints[1].searchAddress.sliderPosition or
				data.payload.wayPoints[1].locationImage.sliderPosition
			 then
