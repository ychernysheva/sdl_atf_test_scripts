...
-- 2) Received notification about changes to destination or waypoints from HMI with empty mandatory wayPoints parameter
...
runner.Step("OnWayPointChange emptyNotification", onWayPointChange)
