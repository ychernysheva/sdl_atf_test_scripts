...
-- in this particular test it is checked case when TTS.Speak gets UNSUPPORTED_RESOURCE and Navi.AlertManeuver gets WARNINGS from HMI
--
...
-- HMI -> SDL: TTS.Speak (UNSUPPORTED_RESOURCE), Navi.AlertManeuver (WARNINGS)
--
-- Expected result:
...
function Test:TestStep_AlerManeuver_TTS_Speak_UNSUPPORTED_RESOURCE()
