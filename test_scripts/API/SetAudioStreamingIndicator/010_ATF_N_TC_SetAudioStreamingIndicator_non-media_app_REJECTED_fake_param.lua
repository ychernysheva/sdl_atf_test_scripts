...
--
-- Description:
-- In case non-media app (or navi, voice-com) sends the SetAudioStreamingIndicator_request to SDL
-- SDL must: respond "REJECTED, success:false" to this non-media app
--
...
--
-- 2. Performed steps
-- Send SetAudioStreamingIndicator(audioStreamingIndicator = "PAUSE", fake parameter)
--
-- Expected result:
...
config.application1.registerAppInterfaceParams.appHMIType = {"DEFAULT", "INFORMATION"}
...
function Test:TestStep_SetAudioStreamingIndicator_REJECTED_PAUSE()
