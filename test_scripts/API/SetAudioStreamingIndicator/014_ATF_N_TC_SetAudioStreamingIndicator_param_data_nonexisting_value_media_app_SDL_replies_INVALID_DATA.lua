...
--
-- 2. Performed steps
-- Send SetAudioStreamingIndicator(audioStreamingIndicator = "LEFT_invalid"),
-- audioStreamingIndicator has "LEFT_invalid": non existing value
--
-- Expected result:
...
function Test:TestStep_SetAudioStreamingIndicator_INVALID_DATA_audioStreamingIndicator_nonexisting()
  local corr_id = self.mobileSession:SendRPC("SetAudioStreamingIndicator", { audioStreamingIndicator = "LEFT_invalid" })
