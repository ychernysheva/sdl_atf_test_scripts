...
--
-- 2. Performed steps
-- Send SetAudioStreamingIndicator(audioStreamingIndicator = "PLAY1"),
-- audioStreamingIndicator has "PLAY1": non existing value
--
-- Expected result:
...
function Test:TestStep_SetAudioStreamingIndicator_INVALID_DATA_audioStreamingIndicator_nonexisting()
  local corr_id = self.mobileSession:SendRPC("SetAudioStreamingIndicator", { audioStreamingIndicator = "PLAY1" })
