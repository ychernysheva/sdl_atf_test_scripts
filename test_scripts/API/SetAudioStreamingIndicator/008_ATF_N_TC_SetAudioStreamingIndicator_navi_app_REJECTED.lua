...
--
-- Description:
-- In case navi app sends the SetAudioStreamingIndicator_request to SDL
-- SDL must: respond "REJECTED, success:false" to this navi app
--
-- 1. Used preconditions
-- Allow SetAudioStreamingIndicator RPC by policy
-- Register and activate first navi application, isMediaApplication = false
-- Register and activate second navi application, isMediaApplication = true
--
-- 2. Performed steps
