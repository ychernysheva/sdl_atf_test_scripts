...
-- Allow SetAudioStreamingIndicator RPC by policy for HMI levels: "BACKGROUND", "NONE", "LIMITED"
-- Register and activate non-media application. HMI level = "FULL"
--
-- 2. Performed steps
...
config.application1.registerAppInterfaceParams.appHMIType = {"INFORMATION", "SOCIAL"}
...
testCasesForPolicyTable:precondition_updatePolicy_AllowFunctionInHmiLeves({"BACKGROUND", "NONE", "LIMITED"}, "SetAudioStreamingIndicator")
