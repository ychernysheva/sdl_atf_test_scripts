...
-- Allow SetAudioStreamingIndicator RPC by policy for HMI levels: "LIMITED", "BACKGROUND", "FULL"
-- Register non-media application. HMI level = "NONE"
--
-- 2. Performed steps
...
config.application1.registerAppInterfaceParams.appHMIType = {"SYSTEM", "DEFAULT", "MESSAGING"}
...
testCasesForPolicyTable:precondition_updatePolicy_AllowFunctionInHmiLeves({"LIMITED", "BACKGROUND", "FULL"}, "SetAudioStreamingIndicator")
