...
-- SDL does:
--  - Send OnDriverDistraction(DD_ON) notification to mobile with "lockScreenDismissalEnabled"=false
...
--    and "lockScreenDismissalWarning" parameters
--  - Resend OnDriverDistraction(DD_ON) notification to mobile with "lockScreenDismissalEnabled"=false
--    and without "lockScreenDismissalWarning" parameters
---------------------------------------------------------------------------------------------------
...
runner.Step("OnDriverDistraction OFF false", common.onDriverDistraction, { "DD_OFF", lockScreenDismissalEnabled })
runner.Step("OnDriverDistraction ON false", common.onDriverDistraction, { "DD_ON", lockScreenDismissalEnabled })
