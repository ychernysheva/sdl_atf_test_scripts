...
local resultCodes = {"SUCCESS", "WARNINGS", "WRONG_LANGUAGE", "RETRY", "SAVED"}
  for i=1,#resultCodes do
    ...
    :Do(function(_,data2) self.hmiConnection:SendResponse(data2.id, "UI.Alert", "WARNINGS", { }) end)
    ...
    :Do(function(_,data3) self.hmiConnection:SendResponse(data3.id, "TTS.Speak", resultCodes[i], { }) end)
