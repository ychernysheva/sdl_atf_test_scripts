--------------------------------------------------------------------------------------------
-- Requirement summary:
-- [MOBILE API] SetMediaClockTimer request/response
-- [HMI API] SetMediaClockTimer request/response
--
-- Description:
-- MOBILE_API: <param name="enableSeek" type="Boolean" mandatory="false">
-- HMI_API:  <param name="enableSeek" type="Boolean" mandatory="false">
--
...
--
-- 2. Performed steps:
-- a) Sens SetMediaClockTimer request with enableSeek = fasle parameter
--
-- Expected result:
-- a) SDL successfylly transfer SetMediaClockTimer with enableSeek = false parameter to HMI and transfer SUCCESS resultCode to mobile
---------------------------------------------------------------------------------------------
...
function Test:TestStep_SetMediaClockTimer_enableSeek_False()
