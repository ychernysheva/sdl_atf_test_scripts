...
--
-- 2. Performed steps:
-- a) Send SetMediaClockTimer request with enableSeek = fasle parameter
--
-- Expected result:
-- a) SDL successfully transfer SetMediaClockTimer with enableSeek = false parameter to HMI and transfer SUCCESS resultCode to mobile
---------------------------------------------------------------------------------------------
