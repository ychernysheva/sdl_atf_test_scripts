...
--
-- 2. Performed steps:
-- a) HMI sends OnSeekMediaClockTimer notification to SDL with wrong seconds value type (string).
--
-- Expected result:
...
function Test:TestStep_OnSeekMediaClockTimer_With_Wrong_seconds_Value_Type_appID()
 self.hmiConnection:SendNotification("UI.OnSeekMediaClockTimer",{seekTime =  {hours = 30, minutes = 30, seconds = "string"}, appID = self.applications["Test Application"]})
