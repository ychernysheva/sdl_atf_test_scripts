...
function Test:TestStep_OnSeekMediaClockTimer_When_App_In_FULL_HMI_Level()
...
function Test:TestStep_OnSeekMediaClockTimer_When_App_In_LIMITED_HMI_Level()
 self.hmiConnection:SendNotification("UI.OnSeekMediaClockTimer",{seekTime =  {hours = 1, minutes = 1, seconds = 40}, appID = self.applications["Test Application"]})
 EXPECT_NOTIFICATION("OnSeekMediaClockTimer", {seekTime = {hours = 1, minutes = 1, seconds = 40}})
end
...
function Test:TestStep_OnSeekMediaClockTimer_When_App_In_BACKGROUND_HMI_Level()
 self.hmiConnection:SendNotification("UI.OnSeekMediaClockTimer",{seekTime =  {hours = 1, minutes = 1, seconds = 40}, appID = self.applications["Test Application"]})
 EXPECT_NOTIFICATION("OnSeekMediaClockTimer", {seekTime = {hours = 1, minutes = 1, seconds = 40}})
end
...
function Test:TestStep_OnSeekMediaClockTimer_When_App_In_NONE_HMI_Level()
 self.hmiConnection:SendNotification("UI.OnSeekMediaClockTimer",{seekTime =  {hours = 1, minutes = 1, seconds = 40}, appID = self.applications["Test Application"]})
 EXPECT_NOTIFICATION("OnSeekMediaClockTimer", {seekTime = {hours = 1, minutes = 1, seconds = 40}})
end
