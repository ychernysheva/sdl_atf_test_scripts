...
--
-- 2. Performed steps:
-- a) HMI sends OnSeekMediaClockTimer notification to SDL with wrong appID value type (string).
--
-- Expected result:
...
function Test:TestStep_OnSeekMediaClockTimer_With_Wrong_appID_Value_Type()
 self.hmiConnection:SendNotification("UI.OnSeekMediaClockTimer",{seekTime = {hours = 30, minutes = 30, seconds = 30}, appID = tostring(self.applications["Test Application"])})
