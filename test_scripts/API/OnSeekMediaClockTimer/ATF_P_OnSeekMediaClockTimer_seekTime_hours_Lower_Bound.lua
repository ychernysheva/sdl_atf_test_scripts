...
--
-- 2. Performed steps:
-- a) HMI sends OnSeekMediaClockTimer notification to SDL with hours lower bound value ("0") of seekTime parameterall.
--
-- Expected result:
...
function Test:TestStep_OnSeekMediaClockTimer_hours_Value_Of_seekTime_Is_Lower_Bound()
