...
--
-- 2. Performed steps:
-- a) HMI sends OnSeekMediaClockTimer notification to SDL without mandatory hours parameter of seekTime.
--
-- Expected result:
...
function Test:TestStep_OnSeekMediaClockTimer_Without_hours_Of_seekTime()
 self.hmiConnection:SendNotification("UI.OnSeekMediaClockTimer",{seekTime =  {minutes = 30, seconds = 30}, appID = self.applications["Test Application"]})
 EXPECT_NOTIFICATION("OnSeekMediaClockTimer", {seekTime = {minutes = 30, seconds = 30}}):Times(0)
end
