...
--
-- 2. Performed steps:
-- a) HMI sends OnSeekMediaClockTimer notification to SDL without mandatory seconds parameter of seekTime.
--
-- Expected result:
...
function Test:TestStep_OnSeekMediaClockTimer_Without_seconds_Of_seekTime()
 self.hmiConnection:SendNotification("UI.OnSeekMediaClockTimer",{seekTime =  {hours = 30, minutes = 30}, appID = self.applications["Test Application"]})
 EXPECT_NOTIFICATION("OnSeekMediaClockTimer", {seekTime = {hours = 30, minutes = 30}}):Times(0)
end
