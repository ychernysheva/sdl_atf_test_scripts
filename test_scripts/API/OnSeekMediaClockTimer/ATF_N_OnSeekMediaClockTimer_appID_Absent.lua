...
--
-- 2. Performed steps:
-- a) HMI sends OnSeekMediaClockTimer notification to SDL without mandatory appID parameter.
--
-- Expected result:
...
function Test:TestStep_OnSeekMediaClockTimer_Without_appID()
 self.hmiConnection:SendNotification("UI.OnSeekMediaClockTimer",{seekTime =  {hours = 30, minutes = 30, seconds = 30}})
