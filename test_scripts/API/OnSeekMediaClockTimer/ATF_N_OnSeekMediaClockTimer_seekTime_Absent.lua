...
--
-- 2. Performed steps:
-- a) HMI sends OnSeekMediaClockTimer notification to SDL without mandatory seekTime parameter.
--
-- Expected result:
...
function Test:TestStep_OnSeekMediaClockTimer_Without_seekTime()
 self.hmiConnection:SendNotification("UI.OnSeekMediaClockTimer",{appID = self.applications["Test Application"]})
