...
-- in particular test it is checked case when UI.SetGlobalProperties gets UNSUPPORTED_RESOURCE and TTS.SetGlobalProperties gets WARNINGS
...
function Test:TestStep_SetGlobalProperties_WARNINGS_to_TTS_SGP_and_UNSUPPORTED_RESOURCE_to_UI_SGP()
  ...
  :Do(function(_,data) self.hmiConnection:SendResponse(data.id, "TTS.SetGlobalProperties", "WARNINGS", {})
  end)
  ...
  :Do(function(_,data) self.hmiConnection:SendResponse(data.id, "UI.SetGlobalProperties", "UNSUPPORTED_RESOURCE", {})
  end)
