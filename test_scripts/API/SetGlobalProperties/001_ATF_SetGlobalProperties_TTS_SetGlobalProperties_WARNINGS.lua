...
-- in this test case when TTS.SetGlobalProperties gets WARNINGS and VR.SetGlobalProperties gets ANY successfull result code is checked
--
...
for i=1,#resultCodes do
  Test["TestStep_SetGlobalProperties_TTS_SGB_WARNINGS_and_UI_SGB_"..resultCodes[i]] = function(self)
    ...
    :Do(function(_,data) self.hmiConnection:SendResponse(data.id, "UI.SetGlobalProperties", resultCodes[i], {}) end)
