...
function Test:TestStep_DeleteCommand()
  ...
  :Do(function(_,data)
    self.hmiConnection:SendResponse(data.id, "VR.DeleteCommand", "UNSUPPORTED_RESOURCE", {})
  end)        
  EXPECT_RESPONSE(cor_id_del_cmd, { success = true, resultCode = "UNSUPPORTED_RESOURCE" })
  EXPECT_NOTIFICATION("OnHashChange")
end
