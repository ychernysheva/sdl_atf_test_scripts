...
-- SDL -> HMI: resends VR.DeleteCommand with all valid params, UI.DeleteCommand with imageType of cmdIcon which is not supported by HMI
-- HMI -> SDL: VR.DeleteCommand (SUCCESS), UI.DeleteCommand (WARNINGS)
--
-- Expected result:
