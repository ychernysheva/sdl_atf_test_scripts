...
-- in this test case when UI.DeleteCommand gets WARNINGS and VR.DeleteCommand gets ANY successfull result code is checked
--
...
-- HMI -> SDL: UI.DeleteCommand (WARNINGS), VR.DeleteCommand (cyclically checked cases for result codes SUCCESS, WARNINGS, WRONG_LANGUAGE, RETRY, SAVED)
--
-- Expected result:
