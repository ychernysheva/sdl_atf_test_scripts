...
--
-- Description: Processing of RPC spec VD in case sdl_preloaded_pt file does not contain vehicle_data section

-- Precondition:
-- 1. Preloaded file does not contain vehicle_data
