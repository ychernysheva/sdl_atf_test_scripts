...
--
-- Description: Processing PTU in case mandatory parameter in custom VD item is missed

-- Precondition:
-- 1. Preloaded file contains VehicleDataItems for all RPC spec VD
-- 2. App is registered and activated
-- 3. PTU is started
-- 4. The update received from cloud contains the custom VD items without
--   mandatory parameters(name, type, key , mandatory)
...
-- [[ Scenario ]]
for number, parameter in pairs(mandatoryParams) do
  runner.Title("TC [" ..  number .."], ".. " mandatory parameter " .. "[".. parameter .. "]")
  runner.Title("Preconditions")
  runner.Step("Clean environment", common.preconditions)
  runner.Step("Start SDL, HMI, connect Mobile, start Session", common.start)
  runner.Step("App registration", common.registerApp)
  runner.Step("App activation", common.activateApp)
  runner.Step("UpdateCustomDataTypeSample", common.updateCustomDataTypeSample, {"custom_vd_item1_integer", parameter } )
  runner.Step("PTU with VehicleDataItems", common.policyTableUpdateWithoutOnPermChange,
