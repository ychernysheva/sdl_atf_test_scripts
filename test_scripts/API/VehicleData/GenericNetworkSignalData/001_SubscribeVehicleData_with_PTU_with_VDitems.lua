...
--
-- Description: Subscription for RPC spec and custom data after PTU with VehicleDataItems
...
-- Sequence:
-- 1. SubscribeVD with VD from VehicleDataItems is requested from mobile app
