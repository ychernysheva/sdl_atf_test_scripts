...
-- in case of non force protection and invalid mobile certificate
--
-- Preconditions:
...
runner.Title("Test")
runner.Step("Start Video Service protected, ACCEPTED", common.startServiceWithOnServiceUpdate, { videoServiceId, 1, 1 })
runner.Step("Start Audio Service protected, ACCEPTED", common.startServiceWithOnServiceUpdate, { audioServiceId, 1, 1 })
