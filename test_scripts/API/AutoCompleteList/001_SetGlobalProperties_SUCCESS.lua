...
--
-- Description:
-- In case mobile application sends valid SetGlobalProperties_request with "autoCompleteList", 
-- SDL must transfer from mobile app to HMI the UI.SetGlobalProperties request. On getting 
...
-- SDL transfers the UI request with autoCompleteList to HMI
