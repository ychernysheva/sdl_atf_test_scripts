...
-- Description:
-- In case:
-- 1. Mobile application sends a PutFile "Multiple Frame" with a negative (not valid) checksum to the SDL.
-- SDL does:
-- 1. SDL receive putfile “Multiple Frame” and counted checksum from the Mobile app and respond with result code "INVALID_DATA"
---------------------------------------------------------------------------------------------------
