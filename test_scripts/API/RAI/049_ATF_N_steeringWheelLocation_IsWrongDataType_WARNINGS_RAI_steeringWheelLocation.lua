...
function Test:TestStep_RAI_steeringWheelLocation()
	...
	EXPECT_RESPONSE(CorIdRegister, { success = true, resultCode = "WARNINGS", steeringWheelLocation = value_steering_wheel_location })
...
function Test.Postcondition_Restore_sdl_preloaded_pt()
