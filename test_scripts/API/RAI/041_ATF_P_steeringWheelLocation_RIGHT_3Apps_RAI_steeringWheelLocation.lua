...
-- In InitHMI_OnReady HMI replies with parameter steeringWeelLocation = RIGHT to UI.GetCapabilities
--
-- 2. Performed steps
-- Register 3 new applications.
--
-- Expected result:
...
function Test:TestStep_RAI_FirstApp_steeringWheelLocation()
	...
	EXPECT_RESPONSE(CorIdRegister, { success=true, resultCode = "SUCCESS", steeringWheelLocation = "RIGHT" })
...
function Test:TestStep_RAI_SecondApp_steeringWheelLocation()
	...
	self.mobileSession1:ExpectResponse(CorIdRegister, { success=true, resultCode = "SUCCESS", steeringWheelLocation = "RIGHT" })
...
function Test:TestStep_RAI_ThirdApp_steeringWheelLocation()
	...
	self.mobileSession2:ExpectResponse(CorIdRegister, { success=true, resultCode = "SUCCESS", hmiCapabilities = { steeringWheelLocation = "RIGHT" } })
