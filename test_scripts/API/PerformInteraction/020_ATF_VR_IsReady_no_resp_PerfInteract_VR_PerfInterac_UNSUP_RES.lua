...
-- in this particular test it is checked case when VR.PerformInteraction gets UNSUPPORTED_RESOURCE and UI.PerformInteraction gets WARNINGS from HMI
--
...
-- HMI -> SDL: VR.PerformInteraction (UNSUPPORTED_RESOURCE), UI.PerformInteraction (WARNINGS)
--
-- Expected result:
...
function Test:TestStep_VR_PerformInteraction_UNSUPPORTED_RESOURCE()
