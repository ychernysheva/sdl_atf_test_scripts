...
--
-- Description:
-- In case: PT is updated with list of values for requestSubType for application App2 and App2 starts regisration
-- SDL does: send list of requestSubType values from PT in OnAppRegistered and UpdateAppList during registration
---------------------------------------------------------------------------------------------------
