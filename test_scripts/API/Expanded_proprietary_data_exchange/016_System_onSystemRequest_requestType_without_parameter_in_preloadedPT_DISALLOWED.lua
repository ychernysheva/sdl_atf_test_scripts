...
-- Description:
-- In case:
-- 1. requestType is absent in PreloadedPT
-- 2. SDL receives the following messages with 'requestType' value:
...
local function updatePreloadedPT()
  ...
  pt.policy_table.app_policies["default"].RequestType = nil
...
runner.Title("Test")
runner.Step("SystemRequest with requestType OEM_SPECIFIC_DISALLOWED", systemRequest)
runner.Step("OnSystemRequest with requestType OEM_SPECIFIC_no_transfer_to_app", onSystemRequest)
