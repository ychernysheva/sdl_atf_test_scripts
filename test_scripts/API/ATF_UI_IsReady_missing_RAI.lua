...
-----------------------------------------------------------------------------------------------
	...
	local function RegisterApplication_Check_Interfaces_Parameters_From_HMI_capabilities_json(TestCaseName)
		...
		Test["TC8_"..TestCaseName .. "_RegisterApplication_Check_"..TestedInterface.."_Parameters_From_HMI_capabilities_json_resultCode_SUCCESS"] = function(self)
			...
			local_paramsRAI.resultCode = resultCode
		...
		--[[TODO: Shall be uncommented when SDL Dcheck is fixed
		Test["TC9_"..TestCaseName .. "_RegisterApplication_Check_"..TestedInterface.."_Parameters_From_HMI_capabilities_json_resultCode_WRONG_LANGUAGE"] = function(self)
		...
		Test["TC10_"..TestCaseName .. "_RegisterApplication_Check_"..TestedInterface.."_Parameters_From_HMI_capabilities_json_resultCode_WARNINGS"] = function(self)
			local local_paramsRAI = params_RAI
			commonTestCases:DelayedExp(iTimeout)
	...
	for i=1, 1 do
		...
		local TestCaseName = "Case_" ..TestData[i].description .. TestData[i].caseID .. "_IsReady_" 
