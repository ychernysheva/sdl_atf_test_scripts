...
-- 5. 10 seconds timer is expired
-- 6. Mobile application adds  Command4
-- SDL does:
-- 1. send SetGlobalProperties with constructed the helpPrompt parameter using added vrCommand.
-- 2. send SetGlobalProperties with updated value for the helpPrompt parameter using added vrCommands
---------------------------------------------------------------------------------------------------
...
runner.Step("SetGlobalProperties with constructed the helpPrompt", SetGlobalPropertiesFromSDL)
