...
-- 3. 10 seconds timer is expired and SDL sends SetGlobalProperties  with constructed the vrHelp parameter using added vrCommands
-- 4. Mobile application adds  Command4
-- 5. SDL sends SetGlobalProperties  with updated value for the vrHelp parameter using added vrCommands
