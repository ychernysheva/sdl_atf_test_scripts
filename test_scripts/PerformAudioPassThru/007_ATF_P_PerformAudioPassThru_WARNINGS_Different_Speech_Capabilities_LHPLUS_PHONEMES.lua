...
--1.1 All parameters are present and within bounds speech capabilities is sent with type = "LHPLUS_PHONEMES"
...
--2.1 SDL sends UI.PerformAudioPassThru (audioPassThruIcon, other params, ttsChunksType = "LHPLUS_PHONEMES") to HMI
...
function Test:TestStep_PerformAudioPassThru_LHPLUS_PHONEMES_WARNINGS()
  testCasesForPerformAudioPassThru:PerformAudioPassThru_Diff_Speech_Capabilities (self, "LHPLUS_PHONEMES")
end
