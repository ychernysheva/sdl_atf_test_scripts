...
--1. Only mandatory parameters are present and within bounds (samplingRate, maxDuration, bitsPerSample, audioType)
...
function Test:TestStep_PerformAudioPassThru_MandatoryParameters_audioPassThruIcon_SUCCESS()
  testCasesForPerformAudioPassThru:PerformAudioPassThru_MandatoryParameters_audioPassThruIcon_SUCCESS (self)
end
