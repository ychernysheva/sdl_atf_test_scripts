...
function Test:PTU()
  ...
  local file = "files/jsons/Policies/Policy_Table_Update/ptu_18708.json"
  ...
  :Do(function(_, _)
      ...
      :Do(function(_, _)
          ...
          self.mobileSession:SendRPC("SystemRequest", {requestType = "PROPRIETARY", fileName = policy_file_name}, file)
