...
function Test:TestStep_Sending_PTS_to_mobile_application()
  ...
  :Do(function(exp_rai,data)
      if (exp_rai.occurences == 1) then
        ...
        :Do(function(exp_on_status_update,data)
            if (exp_on_status_update.occurences == 1) then
              ...
              :Do(function(_,data)
                  ...
                  :Do(function(_,data) time_system_request[#time_system_request + 1] = timestamp() end)

                  --first retry sequence
                  time_wait = (timeout_pts*seconds_between_retries[1]*1000 + 10000)
