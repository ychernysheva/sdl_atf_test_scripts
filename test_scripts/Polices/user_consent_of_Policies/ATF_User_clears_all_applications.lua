...
function Test:Precondition_Unregister_app1()
  local RequestIdUnregister1 = self.mobileSession:SendRPC("UnregisterAppInterface",{})
  EXPECT_RESPONSE(RequestIdUnregister1, { success = true, resultCode = "SUCCESS"})
  :Timeout(2000)
end

function Test:Precondition_Unregister_app2()
  local RequestIdUnregister2 = self.mobileSession2:SendRPC("UnregisterAppInterface",{})
  EXPECT_RESPONSE(RequestIdUnregister2, { success = true, resultCode = "SUCCESS"})
  :Timeout(2000)
end
...
function Test:Check_two_devices_visible_on_device2_connect()
