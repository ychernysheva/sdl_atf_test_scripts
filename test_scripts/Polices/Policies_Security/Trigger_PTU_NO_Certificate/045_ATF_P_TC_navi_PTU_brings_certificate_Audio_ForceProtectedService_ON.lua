...
--
-- Expected result:
-- SDL should return StartServiceACK, encrypt = true to Audio
---------------------------------------------------------------------------------------------
...
function Test:TestStep_Audio_ACK_encrypt_true()
  ...
  :ValidIf(function(_, data)
      if data.frameInfo == 2 then
        if(data.encryption == false) then
          commonFunctions:printError("Service 10: StartService ACK, encryption: false is received")
          return false
        else
          print("Service 10: StartServiceACK, encryption: true")
          return true
        end
