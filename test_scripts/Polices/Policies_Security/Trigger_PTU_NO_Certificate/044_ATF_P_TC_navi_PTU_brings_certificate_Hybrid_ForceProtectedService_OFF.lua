...
--
-- Expected result:
-- SDL should return StartServiceACK, encrypt = true to Hybrid
---------------------------------------------------------------------------------------------
...
function Test:TestStep_Hybrid_ACK_encrypt_true()
  ...
  :ValidIf(function(_, data)
      if data.frameInfo == 2 then
        if(data.encryption == false) then
          commonFunctions:printError("Service 15: StartService ACK, encryption: false is received")
          return false
        else
          print("Service 15: StartServiceACK, encryption: true")
          return true
        end
