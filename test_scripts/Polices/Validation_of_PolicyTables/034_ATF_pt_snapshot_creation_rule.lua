...
local realPathToSnapshot = CORRECT_LINUX_PATH_TO_POLICY_SNAPSHOT_FILE
local originalPathToPtSnapshot
...
function Test:Precondition_StartSDL()
  ...
  originalPathToPtSnapshot = self.changePtsPathInSdlIni(CORRECT_LINUX_PATH_TO_POLICY_SNAPSHOT_FILE)
...
function Test:Postcondition()
  ...
  self.changePtsPathInSdlIni(originalPathToPtSnapshot)
