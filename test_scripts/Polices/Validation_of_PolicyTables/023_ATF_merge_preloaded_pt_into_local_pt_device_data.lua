...
function Test:Test_InitialLocalPT()
  ...
  local checks = {
    ...
    {
      query = 'insert into device(id, hardware, firmware_rev, os, os_version, carrier, max_number_rfcom_ports, connection_type, unpaired) values(1, "iPhone 4", "1.2.57a", "iOS", "4.3", "Verizon", 2, "USB", 1); select id, hardware, firmware_rev, os, os_version, carrier, max_number_rfcom_ports, connection_type, unpaired from device where id = 1;',
      expectedValues = {"1|iPhone 4|1.2.57a|iOS|4.3|Verizon|2|USB|1"}
    }
  }
...
function Test:Test_NewLocalPT()
  ...
  local checks = {
    ...
    {
      query = 'select id, hardware, firmware_rev, os, os_version, carrier, max_number_rfcom_ports, connection_type, unpaired from device where id = 1;',
      expectedValues = {"1|iPhone 4|1.2.57a|iOS|4.3|Verizon|2|USB|1"}
    }
  }
  if not self.checkLocalPT(checks) then
