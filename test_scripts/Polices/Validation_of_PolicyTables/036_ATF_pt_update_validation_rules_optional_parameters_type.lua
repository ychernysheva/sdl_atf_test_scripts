...
local TESTED_DATA = {
  preloaded = {
    policy_table = {
      module_config = {
        certificate = "JBGB672354HJGHYUTUI75GHMJLLMP"
      }
    }
  },
  update = {
...
function Test:updatePolicyInDifferentSessions(PTName, appName, mobileSession)
  ...
  function Test.preparePreloadedPT()
    local preloadedUpdaters = {
      function(data)
        data.policy_table.module_config.certificate = TESTED_DATA.preloaded.policy_table.module_config.certificate
      end
    }
  ...
  function Test.preparePTUpdate()
    local PTUpdaters = {
      function(data)
        data.policy_table.module_config.certificate = TESTED_DATA.update.policy_table.module_config.certificate
      end
    }
  ...
  function Test:CheckPTUinLocalPT()
    ...
    local checks = {
      {
        query = 'select certificate from module_config',
        expectedValues = {TESTED_DATA.preloaded.policy_table.module_config.certificate}
      }
    }
