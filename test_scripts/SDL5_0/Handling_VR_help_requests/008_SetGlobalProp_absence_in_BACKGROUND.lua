...
-- 2. PT is updated with "BACKGROUND" for AddCommand RPC
-- 3. App deactivated to BACKGROUND HMI level
...
local function deactivateApp()
  common.getHMIConnection():SendNotification("BasicCommunication.OnAppDeactivated", {appID = common.getHMIAppId(1)})
  common.getMobileSession(1):ExpectNotification("OnHMIStatus",
...
runner.Step("PTU with BACKGROUND hmi level for AddCommand", common.policyTableUpdate, { ptuFunc })
runner.Step("App deactivation", deactivateApp)
