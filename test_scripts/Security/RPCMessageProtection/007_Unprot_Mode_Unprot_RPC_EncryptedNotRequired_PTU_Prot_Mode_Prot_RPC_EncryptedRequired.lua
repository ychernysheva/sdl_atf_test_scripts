...
-- In case:
-- 1) During PTU parameters updated: app_policies: false -> nil, function_group (Base-4): true -> false
...
runner.Step("Unprotected RPC in unprotected mode", common.unprotectedRpcInUnprotectedModeSuccess)
