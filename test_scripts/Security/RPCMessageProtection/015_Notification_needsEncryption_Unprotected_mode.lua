...
-- 2) SDL does not send notification RPC to mobile application
---------------------------------------------------------------------------------------------------
...
for n, tc in common.spairs(testCases) do
  ...
  runner.Title("Test")
  runner.Step("OnVehicleData in unprotected mode, param for App="..tostring(tc.a)..",for Group="..tostring(tc.f),
    sendOnVD)
