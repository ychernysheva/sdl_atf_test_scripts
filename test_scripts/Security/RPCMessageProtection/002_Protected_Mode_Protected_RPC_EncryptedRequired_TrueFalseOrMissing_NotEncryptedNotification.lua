...
-- 3) RPC doesn't need protection, encryption_required parameters to App within app_policies = false and to the
...
for n, tc in common.spairs(testCases) do
  ...
  runner.Step("Protected RPC in protected mode, param for App="..tostring(tc.a)..",for Group="..tostring(tc.f),
