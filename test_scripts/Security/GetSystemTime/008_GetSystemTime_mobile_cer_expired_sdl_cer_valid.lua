...
-- 2) Mobile certificate is expired and sdl certificates is up to date
-- 3) SDL requests GetSystemTime
-- 4) Mobile certificate is still not valid and sdl certificate is valid according to date/time from GetSystemTime response
-- SDL must:
-- 1) not trigger PTU
...
config.serverCertificatePath = "./files/Security/GetSystemTime_certificates/spt_credential_0311_16.pem"
config.serverPrivateKeyPath = "./files/Security/GetSystemTime_certificates/spt_credential_0311_16.pem"
config.serverCAChainCertPath = "./files/Security/GetSystemTime_certificates/spt_credential_0311_16.pem"
