...
common.Step("Register App 1", common.registerApp, { "MEDIA", 1 })
...
-- set App 2 to BACKGROUND by registering and activating App 3 with the same HMI type
common.Step("Activate App 2", common.app.activate, { 2 })
common.Step("Register App 3", common.registerApp, { "MEDIA", 3 })
common.Step("Activate App 3", common.app.activate, { 3 })
common.Step("Unregister App 3", common.app.unRegister, { 3 })
