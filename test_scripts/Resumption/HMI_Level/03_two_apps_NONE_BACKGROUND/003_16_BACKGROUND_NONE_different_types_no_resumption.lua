...
--  - another app of different HMI type is registered and got NONE HMI level just after unexpected disconnect
...
-- 2) App_2 of different HMI type is registered and got NONE HMI level
...
common.Step("Set HMI level App 2", common.setAppHMILevel, { "NONE", 2 })
common.Step("Register App 1", common.registerApp, { "DEFAULT", 1 })
