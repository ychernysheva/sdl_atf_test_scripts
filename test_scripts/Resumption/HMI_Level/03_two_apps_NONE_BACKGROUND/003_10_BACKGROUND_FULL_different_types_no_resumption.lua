...
--  - app has BACKGROUND level before unexpected disconnect
--  - another app of different HMI type is registered and switched to FULL just after unexpected disconnect
--  - app has been re-registered
--
-- Preconditions:
-- 1) SDL and HMI are started
-- 2) App_1 is registered and switched to BACKGROUND HMI level
--
-- Steps:
-- 1) App_1 is disconnected unexpectedly
-- 2) App_2 of different HMI type is registered and switched to FULL HMI level
...
common.Step("Set HMI level App 1", common.setAppHMILevel, { "BACKGROUND", 1 })

common.Title("Test")
common.Step("Unexpected disconnect", common.unexpectedDisconnect)
common.Step("Register App 2", common.registerApp, { "NAVIGATION", 2 })
common.Step("Set HMI level App 2", common.setAppHMILevel, { "FULL", 2 })
common.Step("Register App 1", common.registerApp, { "DEFAULT", 1 })
