...
--  - another app of the same HMI type is registered and got NONE HMI level just after unexpected disconnect
...
-- 2) App_2 of the same HMI type is registered and got NONE HMI level
