...
--  - another app of the same HMI type is registered and switched to FULL just after unexpected disconnect
...
-- 2) App_2 of the same HMI type is registered and switched to FULL HMI level
