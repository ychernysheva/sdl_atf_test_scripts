...
--  - another app of the same HMI type is registered and switched to LIMITED just after unexpected disconnect
...
-- 2) App_2 of the same HMI type is registered and switched to LIMITED HMI level
