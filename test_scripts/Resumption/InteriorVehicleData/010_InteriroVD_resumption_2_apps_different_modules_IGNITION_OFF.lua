...
runner.Step("Check subscription GetInteriorVD(false) for app1", common.GetInteriorVehicleData, { common.modules[1], false, 1, 1 })
runner.Step("Check subscription GetInteriorVD(false) for app2", common.GetInteriorVehicleData, { common.modules[2], false, 1, 1, 2 })
