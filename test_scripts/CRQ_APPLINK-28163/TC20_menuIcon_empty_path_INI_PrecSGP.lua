...
-- GOAL: Goal of the test is to verify that SDL will not send parameter menuIcon in ResetGlobalProperties
...
------------------------------------------- Test --------------------------------------------
---------------------------------------------------------------------------------------------
	Test["TC20_menuIcon_empty_path_INI_PrecSGP"] = function(self)
