...
-- BEGIN TEST CASE IVSU.2.5
-- Description: SDL has started without db_version_hash value
...
function Test:PrecondRemoveDBVersionHashValue()
	-- body
	local query = "delete from _internal_data"
...
function Test:StartSDL()
	-- body
	CommonFunctions.startSDL(pathToSDL, binaryName, 7)
