...
runner.Step("App2 GetInteriorVehicleData without subscribe " .. common.modules[1], common.GetInteriorVehicleData,
  { common.modules[1], nil, false, 2 })
