...
-- 3. Mobile app1 is unregistered and SDL does not resend request to HMI
-- 4. Mobile app2 unregisters
-- SDL must
...
runner.Step("Absence RC.GetInteriorVehicleData with subscribe=false by app1 unregistration " .. common.modules[1],
  common.unregistrationApp, { 1, false, common.modules[1] })
runner.Step("RC.GetInteriorVehicleData with subscribe=false by app2 unregistration " .. common.modules[1],
  common.unregistrationApp, { 2, true, common.modules[1] })
