...
-- 3. Mobile app2 sends  GetInteriorVD(module_2, without subscribe parameter) request
-- SDL must
...
runner.Step("App1 GetInteriorVehicleData REJECTED CLIMATE", common.GetInteriorVehicleDataRejected,
  {"CLIMATE", nil, 1 })
runner.Step("App2 GetInteriorVehicleData without subscribe parameter RADIO", common.GetInteriorVehicleData,
  { "RADIO", nil, true, 2 })
