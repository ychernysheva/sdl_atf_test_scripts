...
--  - RC module has allowMultipleAccess: true and serviceArea is not defined, location is defined
--     module location is considered as module service area
--  - RC access mode set from HMI: ASK_DRIVER
--  - application sent userLocation which is not within the module location
--
-- Precondition:
...
local testModuleInfo = {
  serviceArea = common.grid.MISSED,
  location = common.grid.FRONT_PASSENGER,
...
for _, testModule in ipairs(testModules) do
  runner.Step("Reject allocation of module [".. testModule.moduleType .. ":" .. testModule.moduleId .. "] to App2",
