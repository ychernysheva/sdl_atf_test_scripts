...
--  - RC module has allowMultipleAccess: false and serviceArea is not defined, location is not defined
--     whole vehicle area is considered as module service area
--  - RC access mode set from HMI: default
--  - application sent userLocation which is within the whole area of the vehicle
--
-- Precondition:
