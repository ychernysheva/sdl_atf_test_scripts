...
-- Description:
--  SDL received seat location capabilities where one element of "seats" array have omitted one of mandatory parameters.
--  In response to the "GetSystemCapability" request from mobile App SDL should substitute these capabilities with
--  the default ones.
--
-- Preconditions:
...
local customSeatLocation = {
  ...
  levels = 2,
  seats = {
    { grid = { col = 0, level = 0, colspan = 1, rowspan = 1, levelspan = 1 }},
