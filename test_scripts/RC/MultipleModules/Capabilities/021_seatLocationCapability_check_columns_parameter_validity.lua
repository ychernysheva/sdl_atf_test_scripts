...
-- Description:
--  SDL received seat location capabilities containing incorrect value of "columns" parameter from the HMI.
--  In response to the "GetSystemCapability" request from mobile App SDL should substitute these capabilities with the
--  default ones.
--
-- Preconditions:
