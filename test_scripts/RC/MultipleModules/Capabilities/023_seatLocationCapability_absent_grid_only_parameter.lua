...
-- Description:
--  SDL received seat location capabilities which does not contain an array parameter "seats".
--  In response to the "GetSystemCapability" request from mobile App SDL should substitute
--  these capabilities with the default ones.
--
-- Preconditions:
