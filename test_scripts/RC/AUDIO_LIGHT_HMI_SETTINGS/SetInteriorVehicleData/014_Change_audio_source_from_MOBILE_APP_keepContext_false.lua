...
-- 3) App tries to change audio source from MOBILE_APP without keepContext parameter defined
-- SDL must:
...
local function setVehicleData()
  ...
  audioData.audioControlData.keepContext = false
  local cid = mobSession:SendRPC("SetInteriorVehicleData", {
      moduleData = audioData
    })
  EXPECT_HMICALL("RC.SetInteriorVehicleData", {
...
runner.Title("Test")
runner.Step("Change audio source from MOBILE_APP keepContext is false", setVehicleData)
