...
--  4) AppServiceConsumer permissions are assigned for <appID2> with PerformAppServiceInteraction
--
--  Steps:
...
local rpc = {
  ...
  params = {
    ...
    futureRequestParameter = "futureRequestParameter",
    futureRequestStruct = {
      futureStructItem = "futureStructItem"
    }
  }
}
