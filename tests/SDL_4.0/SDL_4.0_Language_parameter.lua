Test = require('user_modules/connecttest_json_validation')
...
--===================================================================================--
  ...
  function Test:Precondition_UnregisterAppInterface_JSONWithOmittedLanguageStruct()
    UnregisterApp(self)
  end
...
--TODO: uncomment after resolving APPLINK-17720
  -- end
...
--TODO: uncomment after resolving APPLINK-17720
  ...
  -- function Test:JSONWithOmittedttsNamevrSynonyms()
    ...
    ReceivingUpdateAppListaccordingToJsonInSystemRequest(self, "JSON_Language_parameter/JSONWithoutParametersInOneArrayElement.json", "SUCCESS", UpdateAppListParameters)
          ...
          applications = {
             ...
             },
             {
                ...
                ttsName = {
                  {
                    type = "TEXT",
                    text = "Rap Music tts name"
                  }
                },
                vrSynonyms = {"Rap Music App1", "Rap Music App2"}
             },
             {
                appName = "Rock Music App",
                deviceInfo = {
                ...
                ttsName = {
                  {
                    type = "TEXT",
                    text = "Rock Music tts name"
                  }
                },
                vrSynonyms = {"Rock Music App1", "Rock Music App2"}
             }
            }
        }

    ReceivingUpdateAppListaccordingToJsonInSystemRequest(self, "JSON_Language_parameter/JSONWithcurrentHMIlanElementWithoutDefault.json", "SUCCESS", UpdateAppListParameters)

  end

--[[TODO: update according APPLINK-15443
--===================================================================================--
-- Check that SDL write a values from language struct to the "tts" and "vrSynonym" params and send them via UpdateAppList to HMI in case "language" scruct has only element with not current language and without "default" parameter
--===================================================================================--

  --Precondition: unregistration of app
  function Test:Precondition_UnregisterAppInterface_JSONWithNotcurrentHMIlanElementWithoutDefault()
    UnregisterApp(self)
  end
  ...
  --Precondition: Registration of application
  function Test:Precondition_AppRegistration_JSONWithNotcurrentHMIlanElementWithoutDefault()
    RegistrationApp(self)
  end
  ...
  --language struct has language element with current HMI language and without "default" parameter
  function Test:JSONWithNotcurrentHMIlanElementWithoutDefault()
          ...
          EXPECT_NOTIFICATION("OnSystemRequest")
            :Do(function()
                local CorIdSystemRequest = self.mobileSession:SendRPC("SystemRequest",
                  ...
                  "files/jsons/JSON_Language_parameter/  ")
        ...
        EXPECT_HMICALL("BasicCommunication.UpdateAppList",
                    {
                      applications = {
                       ...
                       {
                          appID = self.applications["Crappy Music App"],
                          appName = "Crappy Music App",
                          deviceName = "127.0.0.1",
                          hmiDisplayLanguageDesired = "EN-US",
                          greyOut = false,
          ...
          :ValidIf(function(_,data)
              if #data.params.applications == 2 then
                return true
                  ...
                  print(" \27[36m Application array in BasicCommunication.UpdateAppList contains "..tostring(#data.params.applications)..", expected 2 \27[0m")
                  return false
                end
            end)
...
--===================================================================================--
-- Check that SDL write a values from RegisterAppInterface to the vrSynonyms and ttsName params and send via UpdateAppList to HMI in case "language" scruct has no values for ttsName and vrSynonyms
--===================================================================================--
...
{          
  ...
  EL_GR = {
      ...
      vrSynonyms = {
        "Κτυπήματος μουσικής εφαρμογή 1",
        "Κτυπήματος μουσικής εφαρμογή 2"
      }
    },
  HU_HU = {
...
local vrSynonymsttsNamesValuesRockApp = 
{
  ...
  RU_RU = {
      ...
      vrSynonyms = {
        "Музыкальное рок приложение 1",
        "Музыкальное рок приложение 2"
      }
    },
  TR_TR = {
  ...
  EL_GR = {
      ...
      vrSynonyms = {
        "Βράχο μουσική εφαρμογή 1",
        "Βράχο μουσική εφαρμογή 2"
      }
    },
  HU_HU = {
