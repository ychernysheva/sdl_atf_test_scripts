Test = require('user_modules/connecttest_SDL4_0_UpdateAppList')
...
-- Check values of parametes in OnSystemRequest header  
    ...
    :Do(function(_,data)
      if  data.params.applications then
        for i=1, #data.params.applications do 
          ...
          elseif data.params.applications[i].deviceInfo.id == "f4ef3e7b102431d7f30aa4e2d8020e922c8f6a8c4d159a711d07f28f30ebbaaf" then
...
--Unregistration of registered app
function Test:Precondition_UnregisterAppInterface()
...
--Set EnableProtocol4 to true in .ini file
function Test:Precondition_EnableSDL40FeatureInIniFile()
    checkSDLPathValue()
