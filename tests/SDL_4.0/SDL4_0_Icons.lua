Test = require('user_modules/connecttest_SDL4_0_icons')
...
--Precondtion: Set EnableProtocol4 value to true, AppIconsFolder to storage in .ini file
...
--===================================================================================--
function Test:RegisterFirstAppAppIconsFolderContainsOneIcon()
	userPrint(34, "=================================== Test  Case ===================================")
	self.mobileSession= mobile_session.MobileSession(
    self,
    self.mobileConnection)
...
function Test:RegisterSecondAppAppIconsFolderContainsTwoIcons()
	userPrint(34, "=================================== Test  Case ===================================")
...
function Test:RegisterThirdAppAppIconsFolderContainsTwoIcons()
	userPrint(34, "=================================== Test  Case ===================================")
...
function Test:SDLSendsIconsInUpdateAppListAfterIGNOFF()
    ...
    :Do(function(_,data)
		...
		:DoOnce(function(_,data)
			...
			OnSystemRequestQueryApps(self, self.mobileSession, _, _, "correctJSON_icons.json")
...
--[=[TODO: uncomment after resolving APPLINK-14538
...
SetEnableProtocol4ValueInIniFileTotrue(self, "IconsStringValuedAppIDForEachAndEveryApp", _, true, "Icons", true, "1048576", true, "0", true)
