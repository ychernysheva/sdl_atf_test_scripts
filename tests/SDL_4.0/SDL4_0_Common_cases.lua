Test = require('user_modules/connecttest_SDL4_0_common')
...
--===================================================================================--
-- Checks that application registers properly if user start on device application which present on HMI.
--===================================================================================--

function Test:ProperlyRegistrationAppPresentHMI()
