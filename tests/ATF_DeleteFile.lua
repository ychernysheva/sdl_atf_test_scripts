--Note: 
	--Update strAppFolder value to real application folder on test machine before running
	
	--List of existing problems:
		--APPLINK-9867: Clarification is needed for UNSUPPORTED_REQUEST resultCode
			--Update test case related to UNSUPPORTED_REQUEST resultCode
		--APPLINK-14212: DeleteFile response: spaceAvailable parameter is wrong value

---------------------------------------------------------------------------------------------
--Test report: Failed test cases are related to APPLINK-14212
---------------------------------------------------------------------------------------------
...
---------------------------------------------------------------------------------------------
	...
	--2.Update Policy with Navigation-1
