...
---------------------------------------------------------------------------------------------
	...
	policyTable:precondition_updatePolicyAndAllowFunctionGroup({"FULL", "LIMITED", "BACKGROUND"}, keep_context, steal_focus)
...
--List of test cases for Integer type parameter:
	...
	--6. IsOutUpperBound
-----------------------------------------------------------------------------------------------
arrayStringParameterInResponse:verify_Array_String_Parameter(Response, {"dtc"}, {1, 15},  {1, 10}, false)
