...
-----------------------------------------------------------------------------------------------
	...
	commonFunctions:newTestCasesGroup("****************************** TEST BLOCK III: Check normal cases of HMI Response ******************************")							
		...
		--Post Condition: Unregister all apps
		...
		for i =1, #testData do
			...
			local function UIChangeRegistration_Response_IsInvalid()
				...
				Test["Change_App1_Params_Case_Response_Is_" ..testData[i].resultCode] = function(self)
					config.application1.registerAppInterfaceParams.appHMIType = {"MEDIA"}
					config.application1.registerAppInterfaceParams.isMediaApplication = true
					config.application1.registerAppInterfaceParams.appID =testData[i].AppID
				end
				
				commonSteps:RegisterAppInterface("Register_App_Case_Response_Is_" ..testData[i].resultCode)
				
				commonSteps:ActivationApp(_,"Activate_App_Case_Response_Is_" ..testData[i].resultCode)
					
				Test["Update_Policy_UIChangeRegistration_Response_Is" ..testData[i].resultCode] = function(self)
					self:change_AppHMIType_By_PTU(1,PTName)		
			...
			--Post Condition: Unregister all apps
			commonSteps:UnregisterApplication("UnRegister_App_Case_Response_Is_" ..testData[i].resultCode)
...
-------------------------------------------------------------------------------------------------------------------------------------------
	...
	for i =1, 2 do 
		Test["TC_APPLINK_18410_Case_Three_Apps_Postcondition_Unregister_App".. i] = function(self)
			self:unregisterAppInterface(i)
		end
	end
	----------------------------------------------------------------------------------------------------------------------------------------
...
commonFunctions:newTestCasesGroup("After PTU, the AppHMITypes of two apps are changed from Media and Communication to BACKGROUND_PROCESS. SDL puts two these apps from LIMITED app to BACKGROUND")
	...
	--PostCondition: Unregister all apps
	commonSteps:UnregisterApplication("TC_APPLINK_18410_Case_Two_Apps_1_Postcondition_Unregister_App1")
	Test["TC_APPLINK_18410_Case_Two_Apps_1_Postcondition_Unregister_App2"] = function(self)
		self:unregisterAppInterface(1)
	end
	----------------------------------------------------------------------------------------------------------------------------------------
...
-------------------------------------------------------------------------------------------------------------------------------------------
	...
	--PostCondition: Unregister all apps
	commonSteps:UnregisterApplication("TC_APPLINK_18410_Case_Two_Apps_2_PostCondition_Unregister_App1")
	
	Test["TC_APPLINK_18410_Case_Two_Apps_2_Postcondiion_Unregister_App2"] = function(self)
		self:unregisterAppInterface(1)
	end
	----------------------------------------------------------------------------------------------------------------------------------------
...
-------------------------------------------------------------------------------------------------------------------------------------------
	...
	--PostCondition: Unregister all apps
	commonSteps:UnregisterApplication("TC_APPLINK_18410_Case_Two_Apps_3_PostCondition_Unregister_App1")
	Test["TC_APPLINK_18410_Case_Two_Apps_3_Postcondition_Unregister_App2"] = function(self)
		self:unregisterAppInterface(1)
	end
	
	--End TC_APPLINK_18410()
	----------------------------------------------------------------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------------------------------------------------------------------------
	...
	--PostCondition: Unregister all apps
	commonSteps:UnregisterApplication("TC_APPLINK_18405_Postcondition_Unregister_App1")
	
	Test["TC_APPLINK_18405_Postcondition_Unregister_MEDIA_App2"] = function(self)
		self:unregisterAppInterface(1)
	end
...
------------------------------------------------------------------------------------------------------------------------------------------------------------ 
	...
	commonFunctions:newTestCasesGroup("TC APPLINK-18408. Apps: Non Media (Communnication) and Non Media (Communication) and only one level either FULL or BACKGROUND at the same time")
 
	local function TC_APPLINK_18408_Case_Two_Non_Media_Communication_Apps()
		
		function Test:TC_APPLINK_18408_Precondition1_Change_App1_To_NonMedia_Communication()
			config.application1.registerAppInterfaceParams.appHMIType = {"COMMUNICATION"}
			config.application1.registerAppInterfaceParams.isMediaApplication = false
		end
		
		commonSteps:RegisterAppInterface("TC_APPLINK_18408_Precondition1_Register_NonMedia_Communication_App1")
		
		function Test:TC_APPLINK_18408_Precondition2_Register_NonMedia_Communication_App2()
			config.application2.registerAppInterfaceParams.appHMIType = {"COMMUNICATION"}
			config.application2.registerAppInterfaceParams.isMediaApplication = false
			self:registerAppInterface2()
		end
		
		commonSteps:ActivationApp(_, "TC_APPLINK_18408_Step1_Activate_First_NonMedia_Communication_App")

		function Test:TC_APPLINK_18408_Step2_Activate_Second_NonMedia_Communication_App()
			self:activate_App(2,2)
		end
		
		function Test:TC_APPLINK_18408_Step3_Activate_First_NonMedia_Communication_App_Again()
			self:activate_App(1,2)
		end
	end
	
	TC_APPLINK_18408_Case_Two_Non_Media_Communication_Apps()
	
	--PostCondition: Unregister all apps
	commonSteps:UnregisterApplication("TC_APPLINK_18408_Unregister_Communication_App1")
	
	Test["TC_APPLINK_18408_Postcondition_Unregister_Comunication_App2"] = function(self)
		self:unregisterAppInterface(1)
	end
	---------------------------------------------------------------------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------------------------------------------------------------------------------------------   
	--Print new line to separate new test cases group
	commonFunctions:newTestCasesGroup("Apps: Non Media (Navigation), Non Media (Navigation) and only one level either FULL or BACKGROUND at the same time ")
    
	local function TC_APPLINK_18408_Case_Two_Non_Media_Navigation_Apps()
	
		function Test:TC_APPLINK_18408_Precondition1_Change_App1_To_NonMedia_Navigation()
			config.application1.registerAppInterfaceParams.appHMIType = {"NAVIGATION"}
			config.application1.registerAppInterfaceParams.isMediaApplication = false
		end
		
		commonSteps:RegisterAppInterface("TC_APPLINK_18408_Precondition2_Register_NonMedia_Navigation1")
		
		function Test:TC_APPLINK_18408_Precondtion3_Register_NonMedia_Navigation_App2()
			config.application2.registerAppInterfaceParams.appHMIType = {"NAVIGATION"}
			config.application2.registerAppInterfaceParams.isMediaApplication = false
			self:registerAppInterface2()
		end
		
		commonSteps:ActivationApp(_, "TC_APPLINK_18408_Step1_Activate_First_NonMedia_Navigation_App")
		
		function Test:TC_APPLINK_18408_Step2_Activate_Second_NonMedia_Navigation_App()
			self:activate_App(2,2)
		end
		
		function Test:TC_APPLINK_18408_Step3_Activate_First_NonMedia_Navigation_App_Again()
			self:activate_App(1,2)
		end
	end
	
	TC_APPLINK_18408_Case_Two_Non_Media_Navigation_Apps()

	--PostCondition: Unregister all apps
	commonSteps:UnregisterApplication("TC_APPLINK_18408_Postcondition_Unregister_Navigation_App1")
	Test["TC_APPLINK_18408_Postcondition_Unregister_Navigation_App2"] = function(self)
		self:unregisterAppInterface(1)
	end
...
------------------------------------------------------------------------------------------------------------------------------------------------------------  
	...
	--PostCondition: Unregister all apps
	commonSteps:UnregisterApplication("TC_APPLINK_18407_PostCondition_Unregister_App1")
		
	Test["TC_APPLINK_18407_Postcondition_Unregister_App2"] = function(self)
		self:unregisterAppInterface(1)
	end
...
------------------------------------------------------------------------------------------------------------------------------------------------------------ 
	...
	--PostCondition: Unregister all apps
	commonSteps:UnregisterApplication("TC_APPLINK_18409_Case1_Postcondition_Unregister_App1")
	
	Test["TC_APPLINK_18409_Case1_Postcondition_Unregister_App2"] = function(self)
		self:unregisterAppInterface(1)
	end
	-------------------------------------------------------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------------------------------------------------------------------------------------------ 
	...
	--PostCondition: Unregister all apps
	commonSteps:UnregisterApplication("TC_APPLINK_18409_Case2_Postcondition_Unregister_App1")
	
	Test["TC_APPLINK_18409_Case2_Postcondition_Unregister_App2"] = function(self)
		self:unregisterAppInterface(1)
	end
	----------------------------------------------------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------------------------------------------------------------------------------------------ 
	...
	--PostCondition: Unregister all apps
	commonSteps:UnregisterApplication("TC_APPLINK_18409_Case3_Postcondition_Unregister_App1")
	
	Test["TC_APPLINK_18409_Case3_Postcondition_Unregister_App2"] = function(self)
		self:unregisterAppInterface(1)
	end
	----------------------------------------------------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------------------------------------------------------------------------------------------ 
	...
	--Post Condition: Unregister all apps
	commonSteps:UnregisterApplication("TC_APPLINK_18409_Case4_Postcondition_Unregister_App1")
	
	Test["TC_APPLINK_18409_Case4_Postcondition_Unregister_App2"] = function(self)
		self:unregisterAppInterface(1)
	end
	
	--End TC_APPLINK_18409
	----------------------------------------------------------------------------------------------------------------------------------------
...
-------------------------------------------------------------------------------------------------------------------------------------------
	...
	for i = 1, #testData do
		...
		--Post Condition: Unregister all Apps
		commonSteps:UnregisterApplication("Postcontidion_UnregisterApplication_FULL"..i)
	end
	---------------------------------------------------------------------------------------------------------------------
...
-------------------------------------------------------------------------------------------------------------------------------------------
	...
	--PostCondition: Unregister all apps
	commonSteps:UnregisterApplication("Case_BACKGROUND1_Postcontidion_UnregisterApplication")
	---------------------------------------------------------------------------------------------------------------------	
...
-------------------------------------------------------------------------------------------------------------------------------------------	
	...
	--PostCondition: Unregister all apps
	commonSteps:UnregisterApplication("Case_BACKGROUND2_Postcontidion_UnregisterApplication")
	---------------------------------------------------------------------------------------------------------------------	
...
-------------------------------------------------------------------------------------------------------------------------------------------
		...
		--PostCondition: Unregister all apps
		commonSteps:UnregisterApplication("Case_BACKGROUND3_Unregister_App")

	--End test case Different HMIStatus7.4
	---------------------------------------------------------------------------------------------------------------------
