...
---------------------------------------------------------------------------------------------
	...
	commonSteps:PutFile("FutFile_icon.png", "icon.png")
	commonSteps:PutFile("FutFile_icon.png", "action.png")
	commonSteps:PutFile("FutFile_MaxLength_255Characters", strMaxLengthFileName255)
-----------------------------------------------------------------------------------------
