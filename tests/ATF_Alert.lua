...
----------------------------------------------------------------------------------------------
	...
	--Description: TC's checks SDL behavior by processing
		...
		--Description: Call Alert pop-up with one SoftButton from mobile application on HMI.
			...
			-- Check:
			-- - reflecting of SoftButton on UI
			-- - behavior of Alert pop-up by pressing SoftButton with DEFAULT_ACTION system action
		...
		--Description: Call Alert request with two SoftButtons from mobile app on HMI
			...
			-- Check:
			-- - reflecting of SoftButtons on UI
			-- - behavior of Alert pop-up by pressing SoftButton with KEEP_CONTEXT system action
		...
		--Description:Call Alert request with three SoftButtons from mobile application on HMI.
			...
			-- Check:
			-- - reflecting of SoftButtons on UI
			-- - behavior of Alert pop-up by pressing SoftButton with STEAL_FOCUS system action in HMIlevel = LIMITED and FULL mode.
		...
		--Description: Call Alert request with four SoftButtons from mobile application on HMI.
			...
			-- Check reflecting of SoftButtons on UI.
