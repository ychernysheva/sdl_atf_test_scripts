...
local commonFunctions = require('ATF_SharedLibraries/commonFunctions')
...
--Use "atf-2.1.3-r1" for running this script because ATF2.2 cannot compare 2 array data table (OnPermissionsChange data on mobile app)
---------------------------------------------------------------------------------------------------------------------
...
----------------------------------------------------------------------------------------------------------------------
	...
	--Description: Using to activate app
	...
	--Description: Using print table for DEBUG and updating scripts
		--table.print = print_r
		--table.print( data.payload )
	function print_r ( t )  
		local print_r_cache={}
...
---------------------------------------------------------------------------------------------------------------------
	...
	local function APPLINK_19922()
		...
		function Test:APPLINK_19922_ActivationApp()
			...
			:Do(function(_,data)
				...
				:Do(function(_,data)
					...
					local CorIdSystemRequest = self.mobileSession1:SendRPC("SystemRequest",
						...
						"files/PTU_OnPermissionChange_AddedGroup.json")
				...
				self.mobileSession1:ExpectNotification("OnPermissionsChange", arrayUpdatePolicyAddGroup )
				--mobile side: Expect OnPermissionsChange notification (default policy)
				self.mobileSession:ExpectNotification("OnPermissionsChange", arrayUpdatePolicyAddGroup )
				:Times(0)
		...
		function Test:APPLINK_19922_UPT_RemovedGroup_CheckOnPermissionChange()
			...
			:Do(function(_,data)
				...
				:Do(function(_,data)
					...
					"files/PTU_OnPermissionChange_RemovedGroup.json")
				...
				--mobile side: Expect OnPermissionsChange notification (specific policy)
				self.mobileSession1:ExpectNotification("OnPermissionsChange", arrayUpdatePolicyRemoveGroup )
				-- :Do(function(_,data) --TODO: USING FOR UPDATING SCRIPT AFTER FIXING APPLINK-20213 DEFECT
					-- table.print = print_r
					-- table.print( data.payload )
				-- end)
				--mobile side: Expect OnPermissionsChange notification (default policy)
				self.mobileSession:ExpectNotification("OnPermissionsChange", arrayUpdatePolicyRemoveGroup )
				:Times(0)
		...
		--TODO debbug after resolving APPLINK-13101
		-- Description: UpdatePolicy and checking the OnPemissionChange notification on default policy
		function Test:APPLINK_19922_UPT_AddedGroup_Default_CheckOnPermissionChange()
			...
			:Do(function(_,data)
				...
				:Do(function(_,data)
					...
					"files/PTU_OnPermissionChange_Default_AddedGroup.json")
		...
		--TODO debbug after resolving APPLINK-13101
		-- Description: UpdatePolicy and checking the OnPemissionChange notification on default policy
		function Test:APPLINK_19922_UPT_RemovedGroup_Default_CheckOnPermissionChange()
			...
			:Do(function(_,data)
				...
				:Do(function(_,data)
					...
					"files/PTU_OnPermissionChange_Default_RemovedGroup.json")
	...
	local function APPLINK_19930()
		...
		-- Description: Activation app
		function Test:APPLINK_19930_ActivationApp()
			self:activateApp(appId, 2)
		end		
		...
		function Test:APPLINK_19930_UserConsentChange_CheckOnPermissionChange()
					...
					:Do(function(_,data)
						...
						:Do(function(_,data)
							...
							"files/PTU_OnPermissionChange_UserConsentGroup.json")
							...
							:Do(function(_,data)
								...
								:Do(function(_,data)
									...
									local RequestIdGetListOfPermissions = self.hmiConnection:SendRequest("SDL.GetListOfPermissions", {appID = self.applications[config.application2.registerAppInterfaceParams.appName]})
									...
									:Do(function(_,data)
										...
										self.hmiConnection:SendNotification("SDL.OnAppPermissionConsent", { appID =  self.applications[config.application2.registerAppInterfaceParams.appName], consentedFunctions = {{ allowed = false, id = 193465391, name = "New"}}, source = "GUI"})
										end)
								end)
							end)
							:Timeout(2000)
					...
					--mobile side: Expect OnPermissionsChange notification (specific policy)
					self.mobileSession1:ExpectNotification("OnPermissionsChange", arrayUserConsentChange )
					
					--mobile side: Expect OnPermissionsChange notification (default policy)
					self.mobileSession:ExpectNotification("OnPermissionsChange", arrayUserConsentChange )
					:Times(0)
		...
		-- Description: Activation app
		function Test:APPLINK_19930_ActivationAppDefault()
			local HMIappID=self.applications[config.application1.registerAppInterfaceParams.appName]
			self:activateApp(HMIappID, 1)
		end		
		...
		-- Description: UpdatePolicy and checking the OnPemissionChange notification on default policy
		function Test:APPLINK_19930_Default_UserConsentChange_CheckOnPermissionChange()
					...
					:Do(function(_,data)
						...
						:Do(function(_,data)
							...
							"files/PTU_OnPermissionChange_Default_UserConsentGroup.json")
					...
					--mobile side: Expect OnPermissionsChange notification
					EXPECT_NOTIFICATION("OnPermissionsChange", arrayUserConsentChange )	
