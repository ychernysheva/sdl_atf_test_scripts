		...
		--Description: In case app sends PerformInteraction (KEYBOARD) AND SDL receives OnKeyboardInput notification from HMI SDL must transfer OnKeyboardInput notification to the app associated with active PerfromInteraction (KEYBOARD) request
			...
			--Description: App receives OnKeyboardInput when user perform PerformInteraction(KEYBOARD)
				function Test:PI_OnKeyboardInputFromPerformInteraction()
					local paramsSend = performInteractionAllParams()
					paramsSend.interactionMode = "MANUAL_ONLY"
					paramsSend.interactionLayout = "KEYBOARD"
					--mobile side: sending PerformInteraction request
					local cid = self.mobileSession:SendRPC("PerformInteraction", paramsSend)
		...
		local function uiResponses()
			...
			if (uiResponse == "SUCCESS") then
				if (arrayKeysPress == nil) then
					...
					self.hmiConnection:SendNotification("Buttons.OnButtonEvent", {name = "SEARCH", mode = "BUTTONDOWN", customButtonID = 1, appID = self.applications["Test Application"]})
					self.hmiConnection:SendNotification("Buttons.OnButtonEvent", {name = "SEARCH", mode = "BUTTONUP", customButtonID = 1, appID = self.applications["Test Application"]})
					self.hmiConnection:SendNotification("Buttons.OnButtonPress", {name = "SEARCH", mode = "SHORT", customButtonID = 1, appID = self.applications["Test Application"]})
				else
...
function Test:deleteInteractionChoiceSet(choiceSetID)
...
function Test:createInteractionChoiceSet_Navi(choiceSetID, choiceID, size, imageArray)
	...
	if (imageArray == nil) then
		cid = self.mobileSession:SendRPC("CreateInteractionChoiceSet",
												{
													interactionChoiceSetID = choiceSetID,
													choiceSet = setChoiseSet_navi(choiceID, size),
												})
	else
		cid = self.mobileSession:SendRPC("CreateInteractionChoiceSet",
												{
													interactionChoiceSetID = choiceSetID,
													choiceSet = setChoiseSet_navi(choiceID, size, imageArray),
												})
	end											
...
---------------------------------------------------------------------------------------------
	...
	local function APPLINK_18309()
		...
		-- Description: CreateInteractionChoiceSet for precondition
		choiceSetIDValues = {1, 2, 3}
		for i=1, #choiceSetIDValues do
				Test["APPLINK_18309_CreateInteractionChoiceSet" .. choiceSetIDValues[i]] = function(self)
						self:createInteractionChoiceSet(choiceSetIDValues[i], choiceSetIDValues[i])
				end
		end
		...
		imageValues = {"turn_left.png", "turn_right.png", "turn_forward.png"}	
		--Description: Putting file(PutFiles)
			function Test:APPLINK_18309_PutFiles()
				for i=1,#imageValues do
					local cid = self.mobileSession:SendRPC("PutFile",
					{			
						syncFileName = imageValues[i],
		...
		function Test:APPLINK_18309_PerformInteraction_VR_ONLY_SUCCESS()
			...
			requestParams.initialPrompt=setInitialPrompt()
			requestParams.interactionMode="VR_ONLY"
			requestParams.interactionChoiceSetIDList={1}
			requestParams.timeout=10000
			
			--PerformInteraction with Interaction Mode "VR_Only"
			self:performInteraction_ViaVR_ONLY_SUCCESS(requestParams, "FULL", 1)
	...
	local function APPLINK_18310()
		...
		function Test:APPLINK_18310_PerformInteraction_BOTH()
			
			local requestParams=performInteractionAllParams()
			requestParams.interactionMode="BOTH"
			requestParams.interactionChoiceSetIDList={2}
			requestParams.timeout=10000
			
			--PerformInteraction with Interaction Mode "BOTH"
			self:performInteraction_ViaBOTH(requestParams)
			
			local function deleteChoiseSet()
				self:deleteInteractionChoiceSet(3)
			end
			--Delete Choiseset
			RUN_AFTER(deleteChoiseSet, 13000)
		...
		function Test:APPLINK_18310_Edit_TTSDelimiter()
		...
		function Test:APPLINK_18310_RegisterAppInterface()
		...
		function Test:APPLINK_18310_ActivationApp()
		...
		choiceSetIDValues = {1, 2, 3}
		for i=1, #choiceSetIDValues do
				Test["APPLINK_18310_CreateInteractionChoiceSet" .. choiceSetIDValues[i]] = function(self)
						self:createInteractionChoiceSet(choiceSetIDValues[i], choiceSetIDValues[i])
				end
		end
		...
		-- Description: PerformInteraction with Interaction Mode "BOTH"
		function Test:APPLINK_18310_Step1()
		...
		function Test:APPLINK_18310_Restore_TTSDelimiter()
			SmartDeviceLinkConfigurations:ReplaceString("TTSDelimiter = \\", "TTSDelimiter = ,")
		end			
	...
	local function APPLINK_18020()
		...
		Test["APPLINK_18020_CreateInteractionChoiceSet_Navi1"] = function(self)
				self:createInteractionChoiceSet_Navi(1, 1, 3, {"turn_left.png", "turn_right.png", "turn_forward.png"})
		end
		Test["APPLINK_18020_CreateInteractionChoiceSet_Navi3"] = function(self)
				self:createInteractionChoiceSet_Navi(4, 4, 3)
		end

		-- Description: PerformInteraction with Interaction Mode "BOTH"
		function Test:APPLINK_18020_PerformInteraction_BOTH()
			...
			requestParams.vrHelp={{position=1,text="VR1",image={imageType="STATIC", value="turn_left.png"}}, {position=2,text="VR2",image={imageType="STATIC", value="icon.png"}}, {position=3,text="VR3",image={imageType="STATIC", value="turn_forward.png"}}}
			requestParams.interactionChoiceSetIDList={1}
		...
		-- Description: --PerformInteraction with Interaction Mode "BOTH"
		function Test:APPLINK_18020_PerformInteraction_BOTH_TIMEOUT()
			...
			requestParams.interactionChoiceSetIDList={4}
			requestParams.timeout=5000
		...
		function Test:APPLINK_18020_PI_BOTH_LIST_WITH_SEARCH()
		...
		function Test:APPLINK_18020_PI_BOTH_KEYBOARD_TIMED_OUT()
	...
	local function APPLINK_18021()
		...
		Test["APPLINK_18021_CreateInteractionChoiceSet_Navi1"] = function(self)
				self:createInteractionChoiceSet_Navi(8, 8, 3, {"turn_left.png", "turn_right.png", "turn_forward.png"})
		end
		Test["APPLINK_18021_CreateInteractionChoiceSet_Navi2"] = function(self)
				self:createInteractionChoiceSet_Navi(12, 12, 3)
		end
		Test["APPLINK_18021_CreateInteractionChoiceSet_Navi3"] = function(self)
				self:createInteractionChoiceSet_Navi(16, 16, 2)
		end		

		-- Description: PerformInteraction with Interaction Mode "BOTH", interactionLayout="KEYBOARD"
		function Test:APPLINK_18021_PI_BOTH_KEYBOARD_TIMED_OUT()
			...
			requestParams.helpPrompt={{text = "Help me!", type = "TEXT"}}
			requestParams.timeoutPrompt={{text = "Hurry!", type = "TEXT"}}
			requestParams.vrHelp={{position=1,text="VR1",image={imageType="STATIC", value="turn_left.png"}}, {position=2,text="VR2",image={imageType="STATIC", value="icon.png"}}}
			requestParams.interactionChoiceSetIDList={8, 12} 
			requestParams.timeout=5000
			requestParams.interactionLayout="KEYBOARD"
		...
		-- Description: PerformInteraction with Interaction Mode "BOTH", interactionLayout="KEYBOARD"
		function Test:APPLINK_18021_PI_BOTH_KEYBOARD_ABORTED_Time1()
		...
		function Test:APPLINK_18021_PI_BOTH_KEYBOARD_ABORTED_Time2()
			...
			requestParams.timeoutPrompt={{text = "Hurry!", type = "TEXT"}}
			requestParams.vrHelp={{position=1,text="VR1",image={imageType="STATIC", value="turn_left.png"}}, {position=2,text="VR2",image={imageType="STATIC", value="icon.png"}}}
			requestParams.interactionChoiceSetIDList={12, 16} 
			requestParams.timeout=5000
			requestParams.interactionLayout="KEYBOARD"
		...
		function Test:APPLINK_18021_PI_BOTH_KEYBOARD_SUCCESS()
	...
	local function APPLINK_18022()
		...
		-- Description: CreateInteractionChoiceSet for Navi
		Test["APPLINK_18022_CreateInteractionChoiceSet_Navi1"] = function(self)
				self:createInteractionChoiceSet_Navi(100, 100, 3, {"turn_left.png", "turn_right.png", "turn_forward.png"})
		end
		Test["APPLINK_18022_CreateInteractionChoiceSet_Navi2"] = function(self)
				self:createInteractionChoiceSet_Navi(200, 200, 2, {"turn_left.png", "turn_right.png"})
		end
		Test["APPLINK_18022_CreateInteractionChoiceSet_Navi3"] = function(self)
				self:createInteractionChoiceSet_Navi(300, 300, 3)
		end
		Test["APPLINK_18022_CreateInteractionChoiceSet_Navi4"] = function(self)
				self:createInteractionChoiceSet_Navi(400, 400, 2)
		end
		...
		function Test:APPLINK_18022_StartVideoStreaming()
		...
		function Test:APPLINK_18022_PI_ICON_ONLY_TIMED_OUT()
			...
			requestParams.helpPrompt={{text = "Help me!", type = "TEXT"}}
			requestParams.timeoutPrompt={{text = "Hurry!", type = "TEXT"}}
			requestParams.vrHelp={{position=1,text="VR1",image={imageType="STATIC", value="icon.png"}}, {position=2,text="VR2",image={imageType="STATIC", value="icon.png"}}}
			requestParams.interactionChoiceSetIDList={100} 
			requestParams.timeout=5000
		...
		function Test:APPLINK_18022_PI_BOTH_ICON_WITH_SEARCH_TIMED_OUT()
		...
		function Test:APPLINK_18022_PI_BOTH_LIST_ONLY_SUCCESS()
			...
			requestParams.timeoutPrompt={{text = "Hurry!", type = "TEXT"}}
			requestParams.vrHelp={{position=1,text="VR1",image={imageType="STATIC", value="icon.png"}}, {position=2,text="VR2",image={imageType="STATIC", value="icon.png"}}}
			requestParams.interactionChoiceSetIDList={300} 
			requestParams.timeout=5000
		...
		function Test:APPLINK_18022_PI_BOTH_ICON_WITH_SEARCH_SUCCESS()
			...
			requestParams.timeoutPrompt={{text = "Hurry!", type = "TEXT"}}
			requestParams.vrHelp={{position=1,text="VR1",image={imageType="STATIC", value="icon.png"}}, {position=2,text="VR2",image={imageType="STATIC", value="icon.png"}}}
			requestParams.interactionChoiceSetIDList={100, 200} 
			requestParams.timeout=5000
			requestParams.interactionLayout="ICON_WITH_SEARCH"
		...
		function Test:APPLINK_18022_PI_BOTH_LIST_WITH_SEARCH_SUCCESS()
			...
			requestParams.timeoutPrompt={{text = "Hurry!", type = "TEXT"}}
			requestParams.vrHelp={{position=1,text="VR1",image={imageType="STATIC", value="icon.png"}}, {position=2,text="VR2",image={imageType="STATIC", value="icon.png"}}}
			requestParams.interactionChoiceSetIDList={300, 400} 
			requestParams.timeout=5000
			requestParams.interactionLayout="LIST_WITH_SEARCH"
		...
		-- Description: PerformInteraction with Interaction Mode "BOTH", interactionLayout="KEYBOARD", SUCCESS
		function Test:APPLINK_18022_PI_BOTH_KEYBOARD_SUCCESS()
			...
			requestParams.timeoutPrompt={{text = "Hurry!", type = "TEXT"}}
			requestParams.vrHelp={{position=1,text="VR1",image={imageType="STATIC", value="icon.png"}}, {position=2,text="VR2",image={imageType="STATIC", value="icon.png"}}}
			requestParams.interactionChoiceSetIDList={200, 400}
			requestParams.timeout=5000
			requestParams.interactionLayout="KEYBOARD"
		...
		function Test:APPLINK_18022_StopVideoStreamings()
