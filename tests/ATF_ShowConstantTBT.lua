...
local appHMITypes = {DEFAULT = false, COMMUNICATION = false, MEDIA = false, MESSAGING = false, NAVIGATION = false, INFORMATION = false, SOCIAL = false, BACKGROUND_PROCESS = false, TESTING = false, SYSTEM = false}

for i=1,#CurrentAppType do
	appHMITypes[CurrentAppType[i]] = true
end
