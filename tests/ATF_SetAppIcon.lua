--Note: 
	--Update storagePath value to real application folder on test machine before running
	--List of existing problems:
		--Test case SetAppIcon_Response_Invalid_JSON_GENERIC_ERROR: if running this test case, some next test cases will be failed (timeout). Run this test case at the first time, then comment this test case to run next test cases
		--Test case SetAppIcon_UI_ResponseWithFakeParamater_SUCCESS: After running this test case, other test case will be failed. => Only run this test case in the second time when other test cases are commented.

---------------------------------------------------------------------------------------------
--Test report: All test cases are passed.
---------------------------------------------------------------------------------------------
