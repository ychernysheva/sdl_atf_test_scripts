...
function module:runSDL()
  ...
  function module:initHMI_onReady(MYmake, MYmodel, MYmodelYear, MYtrim, success)
    ...
    print("Start of custom InitHMI")


  if MYmake ~= nil then
    print("In connecttest make: "..MYmake)
  else  
     print("In connecttest: make is absent") end

  if MYmodel ~= nil then
    print("In connecttest model: "..MYmodel)
  else  
     print("In connecttest: model is absent") end

  if MYmodelYear ~= nil then  
    print("In connecttest modelYear: "..MYmodelYear)
   else  
     print("In connecttest: modelYear is absent") end

  if MYtrim ~= nil then  
    print("In connecttest trim: "..MYtrim)
   else  
     print("In connecttest: trim is absent") end
    --success = success or "SUCCESS"
    critical(false)
    ...
    ExpectRequest("BasicCommunication.GetSystemInfo", true,
      {
        ccpu_version = "ooooooooo",
        language = "EN-US",
