...
-- Perform resumption because of IGN_OFF -> IGN_ON. => menuTitle and menuIcon are resumed
--
-- 2. Performed steps
...
function Test:TestStep_menuIcon_absolute_path_menuTitle_INI_PrecSGP_Resumption()
