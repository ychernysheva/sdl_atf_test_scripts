...
function Test:Precondition_RegisterAppResumption()
  ...
  self.mobileSession = mobile_session.MobileSession(self, self.mobileConnection, config.application1.registerAppInterfaceParams)
...
function Test:TestStep_menuIcon_empty_path_INI_PrecSGP_Resumption_MobileDisconnect()
